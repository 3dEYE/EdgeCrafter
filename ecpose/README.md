...
> `--` denotes COCO-only training, and `O365` denotes additional Objects365 pretraining. The `O365` results are obtained by directly transferring the detection model pretrained on Objects365.
